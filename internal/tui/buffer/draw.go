...
func (b Buffer) DrawCursor() {
    ...
    cursor.SetPos(os.Stdin, b.TermLine + b.CursorLine + 1, b.TermCol + 1)

    fmt.Fprint(os.Stdin, b.CurrentLine.Fg, color.GrayBg, b.CurrentLine.Gutter, visibleContent, pad, color.ResetFormat)
...
func (b Buffer) DrawLine(lineNum int) {
    ...
    cursor.SetPos(os.Stdin, b.TermLine + lineNum + 1, b.TermCol + 1)
    fmt.Fprint(os.Stdin, line.Fg, line.Bg, line.Gutter, visibleContent, pad, color.ResetFormat)
...
func (b Buffer) DrawStatusLine() {
    ...
    cursor.SetPos(os.Stdin, b.TermLine + b.Height, b.TermCol + 1)
...
func (b Buffer) DrawFillLine(lineNum int) {
    ...
    fmt.Fprint(os.Stdin, b.fillLine.Fg, b.fillLine.Bg, b.fillLine.Content, color.ResetFormat)
    cursor.SetPos(os.Stdin, b.TermLine + b.CursorLine + 1, b.TermCol + b.CursorCol + 1)
}
